public struct FB01SynthModule: SynthModule {
    ...
    public let parameterDescriptors: [SynthParameterDescriptor] = [
        ...
        SynthParameterDescriptor(id: "voice.operator.frequencyMultiplier", displayName: "Frequency Ratio", valueKind: .integer, range: SynthSlotRange(0...15), defaultValue: 1, group: "Operator"),
        ...
        SynthParameterDescriptor(id: "voice.operator.totalLevelAdjust", displayName: "Level Adjust", valueKind: .integer, range: SynthSlotRange(0...15), defaultValue: 0, group: "Operator"),
        ...
        SynthParameterDescriptor(id: "voice.operator.keyboardLevelScalingType", displayName: "Keyboard Level Scaling Type", valueKind: .option(["Low keys louder", "Low keys softer", "High keys louder", "High keys softer"]), range: SynthSlotRange(0...3), defaultValue: 0, group: "Operator"),
        ...
        SynthParameterDescriptor(id: "voice.operator.velocityToAttack", displayName: "Velocity to Attack Rate", valueKind: .integer, range: SynthSlotRange(0...7), defaultValue: 0, group: "Operator Envelope"),
        ...
        SynthParameterDescriptor(id: "voice.operator.sustain", displayName: "Sustain Level", valueKind: .integer, range: SynthSlotRange(0...15), defaultValue: 0, group: "Operator Envelope"),
